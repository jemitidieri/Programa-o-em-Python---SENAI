...
velocidade_bola_x, velocidade_bola_y = 0.03,0.05
...
while run:
    ...
    if (raquete1_x < bola_x < raquete1_x + raquete_largura) and (raquete1_y < bola_y < raquete1_y + raquete_largura):
        velocidade_bola_x = -velocidade_bola_x

    
    if (raquete2_x < bola_x < raquete2_x + raquete_largura) and (raquete2_y < bola_y < raquete2_y + raquete_largura):
        velocidade_bola_x = -velocidade_bola_x
